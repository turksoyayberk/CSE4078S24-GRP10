...
def calculate_character_count(json_data):
    ...
    for item in json_data:
        if 'output' in item:
            character_count = len(item['output'])
...
print("Output alanındaki karakter sayılarının ortalaması:", average_character_count)
print("Output alanındaki karakter sayılarının standart sapması:", standard_deviation)