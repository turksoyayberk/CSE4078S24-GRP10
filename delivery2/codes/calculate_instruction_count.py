...
print("Instruction alanındaki karakter sayılarının ortalaması:", average_character_count)
print("Instruction alanındaki karakter sayılarının standart sapması:", standard_deviation)